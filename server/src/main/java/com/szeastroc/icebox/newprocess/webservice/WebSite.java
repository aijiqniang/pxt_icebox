 ...
 * 
 */
@WebServiceClient(name = "WebSite", targetNamespace = "http://action.website.webservice.net.crm.neusoft.com", wsdlLocation = "http://221.215.1.146/HisenseCRMWS/services/WebSite?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://221.215.1.146/HisenseCRMWS/services/WebSite?wsdl");
